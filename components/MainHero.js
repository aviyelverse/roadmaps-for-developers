  ...
  return (
    <section className="relative container flex flex-col-reverse lg:flex-row gap-12 mt-14 lg:mt-28 w-full">
      <div className="flex flex-1 flex-col items-center lg:items-start">
        <h2 className="text-template-blue text-3xl md:text-4xl lg:text-8xl text-center lg:text-left mb-6">
          Frontend Roadmap
        </h2>
        ...
        <div className="flex justify-center flex-wrap gap-6">
          ...
          >
            <button
              type="button"
              className="btn flex items-center bg-transparent hover:bg-green-500 text-template-purple font-semibold hover:text-white py-5 px-7 border border-template-purple hover:border-transparent rounded-lg"
            >
      ...
      <div className="hidden lg:block overflow-hidden bg-template-purple rounded-lg py-3 px-6 bg-opacity-75 absolute h-80 w-1/2 top-32 right-0 lg:-bottom-28 lg:right-0"></div>
    </section>
  );
};
